...
#pragma region Player 
	...
	_loading.LoadSoundResources("player_walk_right", 
		"../resources/sfx/Player/Walk/player_dirt_walk_armorlight_04.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("player_run_left", 
		"../resources/sfx/Player/Run/player_dirt_run_armorlight_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_run_right", 
		"../resources/sfx/Player/Run/player_dirt_run_armorlight_04.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("player_swing_01", 
		"../resources/sfx/Player/Attack/player_swing_blade_medium_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_swing_02", 
		"../resources/sfx/Player/Attack/player_swing_blade_medium_02.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_swing_03", 
		"../resources/sfx/Player/Attack/player_swing_blade_medium_03.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("player_shield_block", 
		"../resources/sfx/Player/Block/player_shield_block.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_shield_draw", 
		"../resources/sfx/Player/Block/player_shield_draw.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("player_to_combat", 
		"../resources/sfx/Player/ToCombat/player_1hand_draw.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_to_stance", 
		"../resources/sfx/Player/ToStance/player_1hand_sheathe.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("player_impact_01",
		"../resources/sfx/Player/Attack/player_impact_01.wav", false, false, 20.0, 10000.0f);
	_loading.LoadSoundResources("player_impact_02",
		"../resources/sfx/Player/Attack/player_impact_02.wav", false, false, 20.0, 10000.0f);
	_loading.LoadSoundResources("player_impact_03",
		"../resources/sfx/Player/Attack/player_impact_03.wav", false, false, 20.0, 10000.0f);

	_loading.LoadSoundResources("player_hit_01",
		"../resources/sfx/Player/player_hit_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_hit_02",
		"../resources/sfx/Player/player_hit_02.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("player_hit_03",
		"../resources/sfx/Player/player_hit_03.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("player_hit_talk_01",
		"../resources/sfx/Player/player_hit_talk_01.wav", false, false, 20.0f, 10000.0f);

#pragma endregion

#pragma region Cat
	_loading.LoadSoundResources("cat_attack_01", 
		"../resources/sfx/Cat/cat_attack_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("cat_attack_02", 
		"../resources/sfx/Cat/cat_attack_02.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("cat_attack_04", 
		"../resources/sfx/Cat/cat_attack_04.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("cat_roar_01", 
		"../resources/sfx/Cat/cat_roar_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("cat_run_01", 
		"../resources/sfx/Cat/cat_run_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("cat_hit_01", 
		"../resources/sfx/Cat/cat_hit_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("cat_dead_01", 
		"../resources/sfx/Cat/cat_dead_01.wav", false, false, 20.0f, 10000.0f);
#pragma endregion

#pragma region Bat
	_loading.LoadSoundResources("bat_forward_01", 
		"../resources/sfx/Bat/bat_forward_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("bat_roar_01", 
		"../resources/sfx/Bat/bat_roar_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("bat_attack_01", 
		"../resources/sfx/Bat/bat_attack_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("bat_attack_02", 
		"../resources/sfx/Bat/bat_attack_02.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("bat_spit_01", 
		"../resources/sfx/Bat/bat_spit_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("bat_dead_01", 
		"../resources/sfx/Bat/bat_dead_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("bat_hit_01", 
		"../resources/sfx/Bat/bat_hit_01.wav", false, false, 20.0f, 10000.0f);
#pragma endregion

#pragma region Hydra
	_loading.LoadSoundResources("hydra_walk_left", 
		"../resources/sfx/Hydra/hydra_walk_left.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("hydra_walk_right", 
		"../resources/sfx/Hydra/hydra_walk_right.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("hydra_attack_01", 
		"../resources/sfx/Hydra/hydra_attack_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("hydra_attack_02", 
		"../resources/sfx/Hydra/hydra_attack_02.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("hydra_attack_03", 
		"../resources/sfx/Hydra/hydra_attack_03.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("hydra_breath_01", 
		"../resources/sfx/Hydra/hydra_breath_01.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("hydra_death_01", 
		"../resources/sfx/Hydra/hydra_death_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("hydra_hit_01", 
		"../resources/sfx/Hydra/hydra_hit_01.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("hydra_idle_01", 
		"../resources/sfx/Hydra/hydra_idle_01.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("hydra_whip_01", 
		"../resources/sfx/Hydra/hydra_whip_01.wav", false, false, 20.0f, 10000.0f);

#pragma endregion

#pragma region Lizard
	_loading.LoadSoundResources("lizard_attack_01", 
		"../resources/sfx/Lizard/lizard_attack_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_attack_02", 
		"../resources/sfx/Lizard/lizard_attack_02.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_bite_01", 
		"../resources/sfx/Lizard/lizard_bite_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_dead_01", 
		"../resources/sfx/Lizard/lizard_dead_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_hit_01", 
		"../resources/sfx/Lizard/lizard_hit_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_idle_01", 
		"../resources/sfx/Lizard/lizard_idle_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_spit_01", 
		"../resources/sfx/Lizard/lizard_spit_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_walk_left", 
		"../resources/sfx/Lizard/lizard_walk_left.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_walk_right", 
		"../resources/sfx/Lizard/lizard_walk_right.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("lizard_fall_01", 
		"../resources/sfx/Lizard/lizard_fall_01.wav", false, false, 20.0f, 10000.0f);
#pragma endregion

#pragma region Snake
	_loading.LoadSoundResources("snake_attack_01", 
		"../resources/sfx/Snake/snake_attack_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("snake_spit_01", 
		"../resources/sfx/Snake/snake_spit_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("snake_attack_03", 
		"../resources/sfx/Snake/snake_attack_03.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("snake_roar_01", 
		"../resources/sfx/Snake/snake_roar_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("snake_dead_01", 
		"../resources/sfx/Snake/snake_dead_01.wav", false, false, 20.0f, 10000.0f);
#pragma endregion

#pragma region Turtle
	_loading.LoadSoundResources("turtle_attack_01", 
		"../resources/sfx/Turtle/turtle_attack_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("turtle_attack_02", 
		"../resources/sfx/Turtle/turtle_attack_02.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("turtle_dead_01", 
		"../resources/sfx/Turtle/turtle_dead_01.wav", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("turtle_hit_01", 
		"../resources/sfx/Turtle/turtle_hit_01.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("turtle_roar_01", 
		"../resources/sfx/Turtle/turtle_roar_01.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("turtle_walk_left", 
		"../resources/sfx/Turtle/turtle_walk_left.wav", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("turtle_walk_right", 
		"../resources/sfx/Turtle/turtle_walk_right.wav", false, false, 20.0f, 10000.0f);
#pragma region Dragon
	_loading.LoadSoundResources("dragon_atk",
		"../resources/sfx/Dragon/dragon_atk.mp3", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("dragon_bite",
		"../resources/sfx/Dragon/dragon_bite.mp3", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("dragon_BreathFire",
		"../resources/sfx/Dragon/dragon_BreathFire.mp3", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("dragon_charge",
		"../resources/sfx/Dragon/dragon_charge.mp3", false, false, 20.0f, 10000.0f);

	_loading.LoadSoundResources("dragon_roar",
		"../resources/sfx/Dragon/dragon_roar.mp3", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("dragon_step",
		"../resources/sfx/Dragon/dragon_step.mp3", false, false, 20.0f, 10000.0f);
	_loading.LoadSoundResources("dragon_wing",
		"../resources/sfx/Dragon/dragon_wing.mp3", false, false, 20.0f, 10000.0f);
#pragma endregion
